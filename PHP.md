...
Write a PHP program that prints the numbers from 1 to 100. For each number:
...
Write a PHP program to generate the lyrics of the song ``99 Bottles of Beer``. For each iteration:

- Print the number of bottles of beer on the wall and the number of bottles in the song.

- Decrement the number of bottles after each verse, and print the next line.

- When the number of bottles reaches ``0``, print the final line to restart the song.

Use the following:

- Function
    ```PHP
    bottleOfBeerLyrics(99);
    ```
- Inverse for loop
- if-else statements
